...
$\approx\$0.045$. The full 60-case suite is estimated at \$0.10--\$0.30 total,
comfortably within a single free-tier API credit. Aggregated costs are surfaced in the
live benchmark dashboard and reported per run in the runner output.
